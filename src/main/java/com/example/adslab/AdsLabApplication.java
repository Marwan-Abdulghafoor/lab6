...
import com.example.adslab.repo.PatientRepository;
...
public class AdsLabApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Patient patient1 = new Patient(null,"P100", "Gillian White", "123456", "white@gmail.com", fairfield, null);
        Patient patient2 = new Patient(null, "P105","Jill Bell", "234567", "bell@gmail.com", fairfield, null);
        Patient patient3 = new Patient(null, "P108","Ian MacKey", "345678", "mac@gmail.com", peoria, null);
        Patient patient4 = new Patient(null, "P110","John Walker", "456789", "walker@gmail.com", chicago, null);
